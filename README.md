...
<!-- 소개 -->
<h2 align="center">👋 Welcome to Hyunji's GitHub!</h2>
<p align="center">📌 백엔드 개발자를 꿈꾸며, 끊임없이 배우고 도전합니다.</p>
<p align="center">✨ 협업과 커뮤니케이션을 중요하게 생각하며, 기술로 문제를 해결하는 걸 즐깁니다!</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/AWS ELB-232F3E?style=for-the-badge&logo=amazon-aws&logoColor=white" />
</p>
...
- **농림축산식품 공공데이터 경진대회 참가** *(2025.05 – 2025.07)*  
- **ICT 한이음 멘토링 자율형 프로젝트 참여** *(2023.04 – 2023.11)*  
- **SQLD 자격증 취득** *(2023.05)*
- **정보처리기사 자격증 취득** *(2025.12)*  
- **씨큐브 코딩 학원 강사(파트타이머)** *(2023.09 – 2025.08)*
- **UMC 6th 해커톤 백엔드 파트 참여** *(2024.07.04 - 05)*
- **덕성여대 네트워크 과목 튜터링** *(2025.03 – 2025.06)*
- **서울데이터허브 시각화경진대회 참가** *(2025.08 - 2025.08.26)*

#### 🏅 교외 수상 내역
- 한이음 드림업 공모전 **금상(과학기술정보통신부장관상)** 수상 🥇 (2025.03 - 2025.11)
